#!/usr/bin/env python3
"""Build print-ready HTML and PDF from SmartECG_Project_Documentation.md"""
...
MD_PATH = os.path.join(ROOT, 'SmartECG_Project_Documentation.md')
HTML_PATH = os.path.join(ROOT, 'SmartECG_Project_Documentation.html')
PDF_PATH = os.path.join(ROOT, 'SmartECG_Project_Documentation.pdf')

HTML_TEMPLATE = """<!DOCTYPE html>
<html lang="he" dir="rtl">
<head>
  <meta charset="UTF-8">
  <title>SmartECG Assist — תיעוד פרויקט</title>
  <style>
    ...
    th {{ background: #1a5276; color: white; padding: 8px; text-align: right; }}
...
<body>
  <div class="cover">
    <h1>SmartECG Assist</h1>
    <p>תיעוד פרויקט מלא — ECG Heartbeat Classification</p>
    <p>Afeka · Machine Learning · 1D CNN · MIT-BIH</p>
    <p>יוני 2026</p>
  </div>
  {body}
</body>
